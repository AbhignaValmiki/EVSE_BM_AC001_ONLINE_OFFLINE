...
// const char* evse_ssid     = "GOPI";
// const char* evse_password = "Amplify@5";
        ...
        case ARDUINO_EVENT_WIFI_STA_DISCONNECTED:
                ...
                reasonLost == WIFI_REASON_AUTH_EXPIRE)
            {
                ...
                else
                {
                  ...
                  esp_wifi_start();
                  Serial.println("WIFI retries exceeded");
                }
            }
