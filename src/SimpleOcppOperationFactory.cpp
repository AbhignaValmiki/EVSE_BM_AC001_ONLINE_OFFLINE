...
/*
 * @brief: Added by Krishna 22/07/2022
 * for Local List
 */
#include "GetLocalListVersion.h"
#include "SendLocalList.h"
...
uint8_t Trigger_connectorID = 0;
bool flag_trigger_metervalues_A = false;
bool flag_trigger_metervalues_B = false;
bool flag_trigger_metervalues_C = false;

bool flag_trigger_status_A = false;
bool flag_trigger_status_B = false;
bool flag_trigger_status_C = false;

extern bool flag_trigger_metervalues_A_serve;
extern bool flag_trigger_metervalues_B_serve;
extern bool flag_trigger_metervalues_C_serve;
...
/*
 * @brief : Local List profile. Added on 22/07/2022
 */
#if 0
...
OcppOperation *makeFromTriggerMessage(WebSocketsClient *ws, JsonObject payload)
{
  ...
  {
    switch (int(payload["connectorId"]))
    {
    case 0:
      count_trigger = 2;
      flag_trigger_metervalues_A = true;
      flag_trigger_metervalues_B = true;
      flag_trigger_metervalues_C = true;
      flag_trigger_metervalues_A_serve = true;
      flag_trigger_metervalues_B_serve = true;
      flag_trigger_metervalues_C_serve = true;
  ...
  else if (!strcmp(messageType, "StatusNotification"))
  {
    ...
    case 0:
      count_trigger = 2;
      flag_trigger_status_A = true;
      flag_trigger_status_B = true;
      flag_trigger_status_C = true;
      Trigger_connectorID = 1;
      return makeOcppOperation(ws, messageType);
      break;
    case 1:
