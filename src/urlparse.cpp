...
//    strcpy(protocol_m,"wss"); // temporarily
  ...
  // if there is no port given in the URL we give the default port 80 @Abhigna
  // if port is given we take the Port mentoned in the URL By parisng @Abhigna
...
// if there is no path we take chargepoint id as path and chargepoint id @Abhigna
if(token == NULL)
{
