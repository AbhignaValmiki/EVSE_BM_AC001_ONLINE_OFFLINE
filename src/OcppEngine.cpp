...
void setChargePointStatusService(ChargePointStatusService *cpss){
  if(i == 0){
    ...
    ocppEngine_chargePointStatusService_C = cpss;
    Serial.println("CCS C is Set");
  }
...
ChargePointStatusService *getChargePointStatusService_A(){
  if (ocppEngine_chargePointStatusService_A == NULL) {
    Serial.print(F("[OcppEngine_A] Error: in OcppEngine, there is no chargePointStatusService set, but it is accessed!\n"));
    //no error catch 
  }
...
ChargePointStatusService *getChargePointStatusService_B(){
  if (ocppEngine_chargePointStatusService_B == NULL) {
    Serial.print(F("[OcppEngine_B] Error: in OcppEngine, there is no chargePointStatusService set, but it is accessed!\n"));
    //no error catch 
  }
